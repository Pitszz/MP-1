...
import copy
from shadow import Dir, LevelData, Game, Egg, Display
...
def test_move_eggs() -> None:
    ...
    # different deepcopy of mock_level_data_x
    ...
    puzzle = copy.deepcopy(mock_level_data_1.puzzle)
    ...
    puzzle_2 = copy.deepcopy(mock_level_data_2.puzzle)
